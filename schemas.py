...
class Recipes(BaseModel):
    title: str = Field(..., min_length=1, max_length=100, description="Title of the recipe")
    time_cooking: int = Field(..., gt=0, description="Time cooking in min")
    ingredients: List[Ingredient] = Field(..., description="List of ingredients")
    description: str = Field(..., min_length=1, max_length=1000, description="Description of recipe")
